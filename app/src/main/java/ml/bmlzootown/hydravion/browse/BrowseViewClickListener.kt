...
private class BrowseViewClickListener(
    ...
    override fun onItemClicked(itemViewHolder: Presenter.ViewHolder?, item: Any?, rowViewHolder: RowPresenter.ViewHolder?, row: Row?) {
        when (item) {
            ...
            context.getString(R.string.live_chat) -> onSettingsSelected(SettingsAction.LIVE_CHAT)
            context.getString(R.string.chat_cookie) -> onSettingsSelected(SettingsAction.CHAT_COOKIE)
